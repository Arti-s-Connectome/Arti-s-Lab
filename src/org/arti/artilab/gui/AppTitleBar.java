 ...
 * 
 * <p>AppTitleBar class creates and controls the Artilab application's title bar.</p>
 * 
...
public class AppTitleBar extends HBox implements AppSizeListener {
	/**
	 * Maximum height of the title bar.
	 */
	...
	/**
	 * Default constructor. Creates the Artilab application title bar.
	 */
	public AppTitleBar() {
	...
	public void sizeChanged(AppSizeEvent e) {                      
		setWidth(e.getWidth());
		buttonBox.setMinWidth(getWidth() - titleLabel.getWidth());
	}
}
